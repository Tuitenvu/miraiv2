var _0x4ec9 = ['. Tên : ', '76499OCKnkc', 'client', 'map', 'Quản lý tin nhắn chờ của bot', 'messageID', 'handleReply', 'exports', '\x0aHãy replay tin nhắn theo số thứ tự bên dưới để duyệt!', '\x0aID : ', '\x0a◆━━━━━━━━━━━━━◆\x0a', '𝕂𝕖̂́𝕥 𝕟𝕠̂́𝕚 𝕥𝕙𝕒̀𝕟𝕙 𝕔𝕠̂𝕟𝕘 𝕧𝕦𝕚 𝕝𝕠̀𝕟𝕘 𝕤𝕦̛̉ 𝕕𝕦̣𝕟𝕘 ', 'name', '🔰Hiện tại không có người dùng || nhóm nào cần duyệt !', '2OMEBDw', '🔮Đang có tổng: ', 'getCurrentUserID', 'Hệ thống admin-bot', 'senderID', 'push', '𝕞𝕖𝕟𝕦 đ𝕖̂̉ 𝕩𝕖𝕞 𝕥𝕠𝕒̀𝕟 𝕓𝕠̣̂ 𝕝𝕖̣̂𝕟𝕙 𝕔𝕦̉𝕒 𝕓𝕠𝕥 <𝟛\n𝐀𝐝𝐦𝐢𝐧 𝐜𝐡𝐢́𝐧𝐡: https://www.facebook.com/thanhdz.adminbot/', 'ID : ', 'filter', '169189yOwkVb', 'CatalizCS (Khánh Fix)', '37kUozbR', 'changeNickname', 'config', 'getThreadList', 'log', 'unsendMessage', 'threadID', 'PENDING', '. người dùng || nhóm đang trong tin nhắn chờ cần bạn duyệt\x0a\x0a', 'sendMessage', 'PREFIX', 'split', 'body', '212068ZYbyAc', '9sDAoOx', 'author', '178826cZBuTe', 'Bot Như Thành <3', 'run', '71928kyFaGo', 'listid', '9111CRnaWy', '1RVcacG', '1qdEcoc', '1.0.2', 'BOTNAME', '  🇻🇳 🐷 ', 'OTHER', 'length', '18829OerwIE'];
